---
description: "Use when turning settled requirements into a process design — produces a context diagram, level-1 DFD (STS split), recursive single-responsibility decomposition, and state inventory. Trigger phrases: structured analysis, DFD, context diagram, decompose processes, process design, STS split, Warnier."
