---
description: "Use when about to create any new skill, agent, or code asset — audits existing assets for overlap, contradiction, and conflict, then recommends new-vs-extend. NOT for spec coverage checks (use spec-inspector). Trigger phrases: audit assets, reuse check, before creating skill, before creating agent, asset overlap, check for duplicates."
name: asset-auditor
tools: [read, search]
---
