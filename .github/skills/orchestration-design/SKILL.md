...
description: "Use when designing runtime control flow from a settled module architecture — swimlane flowchart, staged outcomes, fail-close paths, execution invariants, log channels. Trigger phrases: orchestration design, control flow, swimlane, fail-close, runtime design."
---
