...
description: "Use when designing the physical module architecture from a settled logical DFD and domain model — hexagonal ports and adapters, dependency inward, CLI surface, persistence repositories. Trigger phrases: architecture design, physical architecture, ports and adapters, module dependencies, hexagonal."
---
