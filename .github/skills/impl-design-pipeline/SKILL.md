...
description: "Use when bridging spec design to implementation — orchestrates architecture-design, orchestration-design, prompt-design, records DD# decisions, runs spec-inspector total check before coding. Trigger phrases: implementation design, impl design pipeline, freeze set, pre-implementation design, spec to impl."
---
