---
name: spec-pipeline
description: "Use when orchestrating the full spec-design pipeline — align, I/O and event ledger, inspect, structured analysis, value trace, MVP scope. Trigger phrases: spec pipeline, spec design, full spec, requirements pipeline, end-to-end spec."
---
