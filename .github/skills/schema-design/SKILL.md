---
name: schema-design
description: "Use when an external config or criteria file format is needed — reader-first design, frontmatter plus body two-layer split, attribute routing, disambiguation samples. Trigger phrases: schema design, file format, config schema, criteria schema, frontmatter design."
---
