---
name: domain-model
description: "Use when turning a settled data dictionary or I/O ledger into Python types — value objects, enums, frozen dataclasses, factory patterns. Trigger phrases: domain model, value objects, type-safe model, domain types, Python types from dictionary."
---
