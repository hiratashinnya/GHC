---
name: test-strategy
description: "Use when planning how to test the implementation — unittest per public function, Markdown test cases, commit-before-test workflow, Claude Code e2e. Trigger phrases: test strategy, testing plan, how to test, test approach, TDD, test planning."
---
