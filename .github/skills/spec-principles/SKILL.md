...
description: "Reference for cross-cutting spec and design principles PR1-PR10. Use when designing or reviewing any spec, I/O split, event list, or process design. Trigger phrases: spec principles, PR1, design principles, alignment first, value path."
---
