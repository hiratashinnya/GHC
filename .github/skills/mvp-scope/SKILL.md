---
name: mvp-scope
description: "Use when scoping an MVP after features are enumerated — value/precondition/atomic-group classification, dependency DAG, build order, MVP cut line. Trigger phrases: MVP scope, MVP planning, feature prioritization, build order, dependency DAG, scope MVP."
---
