---
name: standards-test-strategy
description: "Generic project-independent test strategy baseline — knobs for unit test granularity, LLM non-determinism handling, e2e approach. Use as reference when tailoring a project-specific test-strategy skill. Trigger phrases: test strategy standard, generic test strategy, test strategy template, baseline test strategy."
---
