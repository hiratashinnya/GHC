...
description: "Use when requirements start to settle — build an I/O ledger classifying inputs by source, an event-response list, and run a coverage cross-check. Trigger phrases: I/O ledger, event ledger, input output classification, event list, io ledger."
---
