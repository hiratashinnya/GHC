---
name: value-trace
description: "Use when verifying a process design by tracing each event from input to output — source|info|receiver triples, DFD leveling check, severed path detection. Trigger phrases: value trace, event tracing, trace event, DFD leveling, severed path, verify design."
---
