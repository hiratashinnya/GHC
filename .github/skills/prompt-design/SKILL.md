---
name: prompt-design
description: "Use when designing how an LLM is prompted inside a system — role constraints, prompt builder, injection defenses, template catalog with versioning. Trigger phrases: prompt design, LLM prompt, system prompt template, prompt injection defense."
---
