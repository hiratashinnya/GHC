---
name: asset-pipeline
description: "Use when turning a design method into a reusable skill or agent — inventory existing assets, propose generic vs project-specific, build in phases with checkpoints. Trigger phrases: asset pipeline, assetize, create skill from method, build agent from method, method to skill."
---
